# Contributing to OmixCode

Thanks for contributing.

OmixCode is a fast-moving open-source coding-agent CLI with support for multiple providers, local backends, MCP, and a terminal-first workflow. The best contributions here are focused, well-tested, and easy to review.

## Before You Start

- Search existing [issues](https://github.com/omixgg/OmixCode/issues) and [discussions](https://github.com/omixgg/OmixCode/discussions) before opening a new thread.
...
OmixCode supports multiple provider paths. If you change provider logic:
