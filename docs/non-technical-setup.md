# OmixCode for Non-Technical Users
...
OmixCode lets you use an AI coding assistant with different model providers such as:
...
After you run `OmixCode`, the CLI should start and wait for your prompt.
