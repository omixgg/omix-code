# OmixCode Quick Start for macOS and Linux
...
```bash
npm install -g @omixgg/OmixCode@latest
```

## 7. Uninstalling OmixCode

```bash
npm uninstall -g @omixgg/OmixCode
```
