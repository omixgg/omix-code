...
export function REPL({
  ...
  const terminalTitle = sessionTitle ?? agentTitle ?? haikuTitle ?? 'OmixCode';
  ...
  // That write storm is the primary trigger for ~/.OmixCode.json corruption
  // (GH #3117).
  ...
  useEffect(() => {
    const handleSuspend = () => {
      ...
      process.stdout.write(`\nOmixCode has been suspended. Run \`fg\` to bring OmixCode back.\nNote: ctrl + z now suspends OmixCode, ctrl + _ undoes input.\n`);
    };
    const handleResume = () => {
