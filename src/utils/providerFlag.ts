 ...
 *
 * Usage:
 *   OmixCode --provider openai --model gpt-4o
 *   OmixCode --provider gemini --model gemini-2.0-flash
 *   OmixCode --provider mistral --model ministral-3b-latest
 *   OmixCode --provider ollama --model llama3.2
 *   OmixCode --provider anthropic   (default, no-op)
 */
 ...
 *
 * Issue #808: `OmixCode --model <name>` should work standalone so users can
