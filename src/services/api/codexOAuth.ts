...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to OmixCode now.</p>
    <p>OmixCode will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in OmixCode.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in OmixCode.</p>
  </body>
</html>`
}
