export const installCommand = 'npm install -g @omixgg/OmixCode'
...
export const features = [
  ...
  },
  {
    ...
    body: 'save model, base url, auth, and runtime defaults to .OmixCode-profile.json so every clone boots the same way.',
  },
  {
...
export const navLinks = [
  ...
  { href: 'https://github.com/omixgg/OmixCode', label: 'github' },
  { href: 'https://omixgg.com/node/repos/z6MkqDnb/OmixCode', label: 'omixgg' },
] as const
