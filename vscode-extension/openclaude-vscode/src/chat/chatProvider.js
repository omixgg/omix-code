...
function getLaunchConfig() {
  const cfg = vscode.workspace.getConfiguration('OmixCode');
  const command = cfg.get('launchCommand', 'OmixCode');
...
class OmixCodeChatViewProvider {
...
class OmixCodeChatPanelManager {
  constructor(chatController) {
    this._chatController = chatController;
    this._panel = null;
  }
