/**
 * ProcessManager — spawns OmixCode in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The OmixCode binary (e.g. 'OmixCode')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'OmixCode';
