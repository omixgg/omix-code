/**
 * OmixCode build script — bundles the TypeScript source into a single
...
result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.ISSUES_EXPLAINER':
      JSON.stringify('report the issue at https://github.com/omixgg/OmixCode/issues'),
    'MACRO.FEEDBACK_CHANNEL':
      JSON.stringify('https://github.com/omixgg/OmixCode/issues'),
    'MACRO.PACKAGE_URL': JSON.stringify('@omixgg/OmixCode'),
...
if (!result.success) {
  ...
  console.log(`✓ Built OmixCode v${version} → dist/cli.mjs`)
}
