...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/OmixCode.proto')
...
const OmixCodeProto = protoDescriptor.OmixCode.v1
...
async function main() {
  ...
  const client = new OmixCodeProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mOmixCode gRPC CLI\x1b[0m')
